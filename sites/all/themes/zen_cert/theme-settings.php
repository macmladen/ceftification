 ...
 */
function zen_cert_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['zen_cert_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('zen_cert sample setting'),
  '#default_value' => theme_get_setting('zen_cert_example'),
